      ...
      <div className="w-[95%] grid grid-cols-1 lg:grid-cols-2 gap-12 items-center md:pl-10">
        ...
        <div className="space-y-8 text-center md:text-left">
          <h1 className="text-5xl md:text-6xl font-bold text-gray-900 dark:text-white leading-tight">
            {t("titleOne")}{" "}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-chart-1 to-chart-5">
              {t("titleTwo")}
            </span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row lg:flex-col gap-4 md:max-w-md">
            <Button
              variant="ghost"
              className="rounded-full px-8 py-4 border-2 border-indigo-600 bg-gradient-to-r from:bg-chart-1 to:bg-chart-5 text-indigo-600 hover:shadow-md hover:scale-105 transition-transform duration-300 font-semibold text-xl"
            >
              {t("b1")}
            ...
            <Button
              variant="ghost"
              className="rounded-full px-8 py-4 border-2 border-indigo-600 bg-gradient-to-r from:bg-chart-1 to:bg-chart-5 text-indigo-600  hover:shadow-lg hover:scale-105 transition-transform duration-300 font-semibold text-xl"
            >
              {t("b2")}
            </Button>
            <Button
